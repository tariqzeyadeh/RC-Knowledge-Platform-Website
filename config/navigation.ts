...
/** Platform sidebar — knowledge workers (not superAdmin portal) */
...
/** SuperAdmin portal sidebar — analytics first as landing */
export const superAdminNavStructure: NavGroupDef[] = [
  {
    titleKey: "adminPortal",
    items: [
      { labelKey: "analytics", href: "/analytics", icon: "BarChart3" },
      { labelKey: "workflow", href: "/admin/workflow", icon: "GitBranch" },
      { labelKey: "users", href: "/admin/users", icon: "UserCog" },
      { labelKey: "manageNotifications", href: "/admin/notifications", icon: "Megaphone" },
...
function buildNavGroups(structure: NavGroupDef[], dict: Dictionary): NavGroup[] {
...
export function getNavGroups(dict: Dictionary): NavGroup[] {
  return buildNavGroups(navStructure, dict)
}

export function getSuperAdminNavGroups(dict: Dictionary): NavGroup[] {
  return buildNavGroups(superAdminNavStructure, dict)
}
